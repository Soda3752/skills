...
- **問題不准擋住推進。** 要問就把問題累積成一份清單貼出來，然後在
  同一則訊息裡繼續開下一波——只把真正受那個決策影響的票留下不派，
  其餘照開。除非整波每一張都卡在同一個未決事項，才可以整批停下來等我。
- 每一波收工貼一次進度（做完哪幾張、驗收清單、下一波派了哪幾張），
  貼完直接接著做，不要等我回話。
...
只有沒有合理預設可選、或決定會破壞既有功能時才需要問我——但問題只列清單，
不准因此停住：只留下真正受影響的那張票，其餘照開。
每波收工貼一次進度就直接接著做，回報結尾不准是問句。
```
